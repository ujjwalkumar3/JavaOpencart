...
public class OpentheLinkInNewTab {
	...
	public static void main(String[] args) {
		...
		//getWindowHandles return set, convert in list collection because of indexing concept
		//in set no get using index so use new ArrayList will convert set in list
